...
I'm working on a few things at the moment. I can't quite find the time to do everything I want, but that's the struggle of life I guess.

My cuurrent focus is split in half:
- Connectivity to the Interactive Broker API (May expand to Binance later on as it's cheaper to access crypto market data)
